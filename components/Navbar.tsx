...
export const Navbar: React.FC = () => {
  return (
    <div className="navbar bg-white/95 backdrop-blur-md fixed top-0 z-50 border-b border-slate-200 px-4 md:px-8">
      <div className="navbar-start gap-2">
        ...
        <Link to="/" className="text-xl font-bold text-slate-900">Quobo</Link>
      </div>
